...
export default function Component() {
  ...
  return (
    <div className={styles.footer}>
      {saved ? (
        <h1 style={{ color: "#48C9B0 " }} className={styles.footerTitle}>
      ...
      <ul className={styles.links}>
        ...
        <Link
          href={
            "https://truts.gitbook.io/truts-docs/introduction/table-of-contents"
          }
        >
          <li>Docs</li>
        </Link>
        <Link href={"https://discord.truts.xyz"}>
          <li>Contact Us</li>
        </Link>
      </ul>
